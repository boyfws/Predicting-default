...
class TargetRateTest:
    ...
    def plot_validation(
        ...
        plt.errorbar([1], [mean_prob_pct],
                     yerr=[
                         [mean_prob_pct - ci_95_pct[0]],
                         [ci_95_pct[1] - mean_prob_pct]
                     ],
                     fmt="o",
        ...
        plt.errorbar([1], [mean_prob_pct],
                     yerr=[
                         [mean_prob_pct - ci_99_pct[0]],
                         [ci_99_pct[1] - mean_prob_pct]
                     ],
                     fmt="o",
    ...
    def __call__(
        ...
        mean_prob, actual_rate, ci_95, ci_99 = self.compute_metrics(predicted_probs, actual_events)
